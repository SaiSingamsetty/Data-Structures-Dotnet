...
namespace DataStructures.ProblemSolving.LeetCode.Challenge30Days.May.WeekThree
{
    ...
    public class KthSmallestElementInBst
    {
        ...
        private static void RecursiveHelperForApproach1(TreeNode node)
        {
            if (node.left != null)
            {
                RecursiveHelperForApproach1(node.left);
            }
            ...
            if (node.right != null)
            {
                RecursiveHelperForApproach1(node.right);
            }
        }
        ...
        private static void RecursiveHelperForApproach3(TreeNode node)
        {
            if (node.left != null)
            {
                RecursiveHelperForApproach3(node.left);
            }
            _count--;
            if (_count == 0)
            {
            ...
            if (node.right != null)
            {
                RecursiveHelperForApproach3(node.right);
            }
        }
